...
// Cria um regra para o grupo de rotas, que nesse caso é um prefixo que cada rota que
// estiver dentro do grupo levara junto, "/api". Assim não é necessário declarar em cada uma
// das rotas o "/api".
$router->group(['prefix' => 'api', 'middleware' => 'autenticador'], function () use ($router) {
    ...
    $router->group(
        ['prefix' => 'episodios'], function () use ($router) {
